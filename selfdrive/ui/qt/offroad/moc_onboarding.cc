...
QT_MOC_LITERAL(4, 52, 21), // "scrollPositionChanged"
QT_MOC_LITERAL(5, 74, 8) // "position"

    },
    "OnboardingWindow\0onboardingDone\0\0"
    "updateActiveScreen\0scrollPositionChanged\0"
    "position"
};
#undef QT_MOC_LITERAL
...
void OnboardingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->scrollPositionChanged((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
